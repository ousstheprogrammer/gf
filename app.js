document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = (date) => {
    ...
    let seconds = (date - current) / 1000;
    if (seconds < 0) {
      document.getElementById("clock").innerHTML = "The event has started!";
      return;
    }
  ...
  const textAnimate = async () => {
    ...
    const memorialDate = new Date("2024-12-29T15:00:00"); // Sunday 15:00
